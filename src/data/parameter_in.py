...
def input_to_json(road_width, target_min_area, target_max_area, road_edge_point_list):
  ...
  input_data = {'road_width': road_width,
                'min_maguchi': min_maguchi, 'max_maguchi': max_maguchi, 
                'target_min_area': target_min_area, 'target_max_area': target_max_area, 'road_edge_point_list': road_edge_point_list}
